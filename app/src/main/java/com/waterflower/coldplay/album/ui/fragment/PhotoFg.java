...
public class PhotoFg extends MvpFragment<MvpPresenter> {
    ...
    private static final String[] ctTitles = {"全部", "相册"};


    public static PhotoFg newInstance() {
        PhotoFg newInstance = new PhotoFg();
        return newInstance;
    }
    ...
    private void initCtTab() {
        ...
        fragments.add(PhotoCommonRvFg.newInstance("0"));
...
//                ((ProjectFragment) getParentFragment()).setState(position==0?STATE_ONLINE:STATE_OFFLINE);
            }
        });
