...
import com.waterflower.coldplay.waterflower.basic.manager.FileManager;
import com.waterflower.coldplay.waterflower.basic.model.BaseBean;
import com.waterflower.coldplay.waterflower.basic.network.RequestInfo;
...
//                    禁止提示错误信息
                    if (!"暂无符合条件的数据".equals(responseInfo.getMsg())&&!"支付密码不正确".equals(responseInfo.getMsg())) {
