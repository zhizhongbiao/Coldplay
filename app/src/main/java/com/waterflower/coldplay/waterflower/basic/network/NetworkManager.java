package com.waterflower.coldplay.waterflower.basic.network;
...
import com.waterflower.coldplay.waterflower.basic.manager.CacheManager;
import com.waterflower.coldplay.waterflower.basic.manager.DataManager;
import com.waterflower.coldplay.waterflower.basic.model.BaseBean;
import com.waterflower.coldplay.waterflower.basic.presenter.Callback;
...
import com.waterflower.coldplay.waterflower.basic.view.MvpView;
...
//                LogUtils.d("url   "+url+"  code  "+jsonObject.getIntValue("code")+"   data: " + data);
                LogUtils.d("url   " + url + "  count  " + jsonObject.getIntValue("count") + "  status  " + jsonObject.getIntValue("status") + "   data: " + data);
